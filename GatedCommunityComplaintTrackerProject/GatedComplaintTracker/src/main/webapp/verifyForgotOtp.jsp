...
<head>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .back-link { display: block; margin-top: 15px; color: #1a3c6e; text-decoration: none; font-size: 13px; font-weight: 600; }
    </style>
</head>
<body>
<div class="card">
    <div class="icon">📧</div>
    <h2>Enter OTP</h2>
    <p>6-digit OTP sent to your email</p>
    ...
    <a href="forgotPassword.jsp" class="back-link">← Resend OTP</a>
</div>
<script>
